    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.values(signUpFormState.errors).every((error) => error === '')) {
            ...
            const result = await createUser(
                { username: signUpFormState.username, password: signUpFormState.password });
                ...
                <Form onSubmit={handleSubmit} onFocus={handleInputFocus}>
                    <Form.Group className='mb-2' controlId='formGroupName'>
                        ...
                        <Form.Control required type='text' placeholder='Enter Name' name='username'
                            value={signUpFormState.username} onChange={handleInputChange} isInvalid={!!signUpFormState.errors.username} />
