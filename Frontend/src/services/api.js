...
//   try {
//     const response = await axios.put(`http://localhost:5000/user/resetPassword`, {
//       password,
//       token,
//     });
//     return response;
...
//       `http://localhost:5000/problems/edit/${problemId}`,
//       { headers }
//     );
...
//       `http://localhost:5000/problems/delete/${problemId}`,
//       {
//         headers,
//       }
//     );
...
export const fetchSubmissions = async (token) => {
  try {
    ...
    const response = await axios.get(`http://localhost:5000/submissions/history`, {
      headers,
    });
    return response.data.data;
  } catch (error) {
...
//     };
//     const response = await axios.get(
//       `http://localhost:5000/submissions/leaderBoard`,
//       {
//         headers,
//       }
//     );
